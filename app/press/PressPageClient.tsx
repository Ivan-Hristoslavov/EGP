...
export function PressPageClient({
  awards,
  pressFeatures,
}: PressPageClientProps) {
  // Filter state
  const [activeFilter, setActiveFilter] = useState<"all" | "award" | "press">(
    "all",
  );
  ...
  const [modalDescriptionExpanded, setModalDescriptionExpanded] =
    useState(false);
  ...
  const groupItemsIntoRows = (items: PressItem[], isFeatured: boolean) => {
    ...
    const rows: Array<{
      items: PressItem[];
      rowType: "large-small" | "three-small" | "small-large";
    }> = [];
    let i = 0;
    let patternIndex = 0;
  ...
  const getCardSizeFromRow = (
    ...
    if (isFirstFeatured) {
      return {
        ...
        height: "h-[200px] sm:h-[280px] md:h-[360px] lg:h-[400px]",
        isLarge: true,
      };
    }
    ...
    if (totalItemsInRow === 1) {
      return {
        colSpan: "col-span-12",
        height: "h-[200px] sm:h-[280px] md:h-[360px]",
        isLarge: true,
      };
    }
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className={`${layout.containerWide} pt-16 sm:pt-20 pb-8 sm:pb-12`}>
        ...
        <div className="relative flex items-center justify-between mb-4 sm:mb-6">
          ...
          <h1
            className={`absolute left-1/2 -translate-x-1/2 text-lg sm:text-2xl md:text-3xl font-bold ${textColors.heading} font-montserrat`}
          >
            Awards & Press
          </h1>
        ...
        <div className="text-center mb-6">
          <p
            className={`${typography.lead} font-montserrat font-light max-w-3xl mx-auto mb-4`}
          >
          ...
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-4 sm:mb-6 flex-wrap">
            ...
            <Button
              className={
                activeFilter === "all" ? "bg-[#9d9585] text-white" : ""
              }
            ...
            <Button
              className={
                activeFilter === "award" ? "bg-[#9d9585] text-white" : ""
              }
            ...
            <Button
              className={
                activeFilter === "press" ? "bg-[#9d9585] text-white" : ""
              }
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 z-20 flex flex-col gap-2 items-end">
                    ...
                    <span
                      className={`px-2.5 py-1.5 rounded-full flex items-center gap-1.5 shadow-lg text-[10px] font-bold ${
                        item.type === "award"
                  ...
                  <div className="absolute inset-0 z-10 flex flex-col justify-between p-4 sm:p-5 md:p-6">
                    ...
                    <div className="flex flex-col items-start">
                      <h3
                        className={`text-white font-bold mb-2 ${index === 0 ? "text-lg sm:text-xl md:text-2xl lg:text-3xl" : "text-base sm:text-lg md:text-xl"} leading-tight drop-shadow-lg`}
                      >
                        {item.title}
                      </h3>
                    </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 z-10 flex flex-col justify-between p-4 sm:p-5 md:p-6">
                        ...
                        <div className="flex flex-col items-start">
                          <h3
                            className={`text-white font-bold mb-2 leading-tight line-clamp-2 drop-shadow-lg ${isLarge ? "text-base sm:text-lg md:text-xl lg:text-2xl" : "text-sm sm:text-base md:text-lg"}`}
                          >
                            {item.title}
                          </h3>
                        </div>
                  ...
                  <div className="relative w-full h-[200px] sm:h-[280px] md:h-[350px] lg:h-[400px] overflow-hidden -m-6 mb-0">
                    ...
                    <div className="absolute top-16 sm:top-20 right-4 z-10 flex flex-row gap-2 items-start flex-wrap justify-end">
                      ...
                      <Chip
                        ...
                        color={
                          selectedItem.type === "award" ? "warning" : "primary"
                        }
                        size="sm"
                        startContent={
                          selectedItem.type === "award" ? (
