      ...
      if (dbProfile) {
        ...
        setProfileData((prev) => ({
          ...
          businessEmail:
            ...
            "",
          phone: dbProfile.phone || siteConfig.contact.phone,
          whatsapp:
            (dbProfile as any).whatsapp ||
            dbProfile.phone ||
          ...
          googleMapsAddress:
            (dbProfile as any).google_maps_address ||
            dbProfile.company_address ||
            "809 Wandsworth Road, SW8 3JH, London, UK",
        ...
        setProfileData((prev) => ({
          ...
          businessEmail:
            prev.businessEmail || process.env.NEXT_PUBLIC_BUSINESS_EMAIL || "",
          phone: prev.phone || siteConfig.contact.phone,
          companyName: prev.companyName || "EGP Aesthetics",
          companyAddress:
            prev.companyAddress || "809 Wandsworth Road, SW8 3JH, London, UK",
        }));
      }
    }
  }, [dbProfile, loading]);
      ...
      <div className="w-full p-6">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
          ...
          <p className="text-sm text-red-500 dark:text-red-400 mt-2">
            Please check that the admin profile exists in the database. You may
              ...
              <div className="flex flex-col sm:flex-row sm:gap-4 gap-1 mt-2 text-white/80 text-xs sm:text-sm">
                <span className="flex items-center gap-1.5 truncate">
                  ...
                  <span className="truncate">
                    {dbProfile?.email || profileData.businessEmail}
                  </span>
                </span>
                <span className="flex items-center gap-1.5 truncate">
            ...
            <div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                  This address will be used for the Google Maps embed and
                  directions. Use the exact format: Street, Postcode, City,
                  Country
                </p>
                <input
                  ...
                  onChange={(e) =>
                    setProfileData((prev) => ({
                      ...prev,
                      googleMapsAddress: e.target.value,
                    }))
                  }
                />
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {(profileData.transportOptions?.tube || []).map(
                        ...
                        >
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updated = [
                                  ...(profileData.transportOptions?.tube || []),
                                ];
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {(profileData.transportOptions?.bus || []).map(
                      (item: any, index: number) => (
                        <div
                          key={index}
                          className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end"
                        >
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updated = [
                                  ...(profileData.transportOptions?.bus || []),
                                ];
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {(profileData.transportOptions?.car || []).map(
                      (item: any, index: number) => (
                        <div
                          key={index}
                          className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end"
                        >
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updated = [
                                  ...(profileData.transportOptions?.car || []),
                                ];
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {(profileData.transportOptions?.walking || []).map(
                      (item: any, index: number) => (
                        <div
                          key={index}
                        ...
                        >
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updated = [
                                  ...(profileData.transportOptions?.walking ||
                                    []),
                                ];
                      ...
                      <div className="flex gap-2 items-end">
                        ...
                        <div className="flex items-center pb-0.5">
                          <button
                            ...
                            onClick={() => {
                              const updated =
                                profileData.nearbyLandmarks.filter(
                                  (_, i) => i !== index,
                                );
