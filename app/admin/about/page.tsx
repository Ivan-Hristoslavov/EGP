...
export default function AdminAboutPage() {
  ...
  const uploadImageIfNeeded = async () => {
    if (selectedImage) {
      const fileForUpload = await compressImage(
        selectedImage,
        compressionQuality,
      );
  ...
  const handleEditSection = (section: AboutSection) => {
    ...
    setFormData({
      ...
      bullet_points: Array.isArray(section.bullet_points)
                ...
                <div className="space-y-6">
                  ...
                  <Select
                    ...
                    onSelectionChange={(keys) => {
                      ...
                      if (v)
                        setFormData((prev) => ({ ...prev, section_type: v }));
                    }}
                  >
                    <SelectItem key="hero">
                      Hero (main intro + image)
                    </SelectItem>
                    <SelectItem key="story">Story</SelectItem>
                    <SelectItem key="values">
                      Values (with bullet points)
                    </SelectItem>
