              ...
              {Object.entries(groupedTabs).map(([category, categoryTabs]) => (
                <div key={category} className="space-y-3">
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full bg-${categories[category as keyof typeof categories].color}-500`}
                    />
                  ...
                  <div className="space-y-2">
                    {categoryTabs.map((tab) => (
                      ...
                      >
                        {/* Ripple effect */}
                        {clickedTab === tab.id && (
                          <div className="absolute inset-0 bg-blue-200 dark:bg-blue-700 opacity-30 animate-ping" />
                        )}
