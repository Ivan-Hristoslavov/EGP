...
export const ToastMessages = {
  ...
  gallery: {
    itemAdded: {
      ...
      message:
        "Your gallery item has been successfully added to the collection.",
    },
    itemUpdated: {
    ...
    error: {
      title: "Gallery Error",
      message:
        "Sorry, there was an issue with the gallery operation. Please try again.",
    },
  },
  ...
  faq: {
    ...
    error: {
      title: "FAQ Error",
      message:
        "Sorry, there was an issue with the FAQ operation. Please try again.",
    },
  },
  ...
  pricing: {
    ...
    error: {
      title: "Pricing Error",
      message:
        "Sorry, there was an issue with the pricing operation. Please try again.",
    },
  },
  ...
  areas: {
    ...
    error: {
      ...
      message:
        "Sorry, there was an issue with the service area operation. Please try again.",
    },
  },
  ...
  reviews: {
    approved: {
      ...
      message:
        "The customer review has been approved and is now visible on your website.",
    },
    deleted: {
    ...
    error: {
      title: "Review Error",
      message:
        "Sorry, there was an issue with the review operation. Please try again.",
    },
  },
  ...
  profile: {
    ...
    error: {
      title: "Profile Error",
      message:
        "Sorry, there was an issue updating your profile. Please try again.",
    },
  },
  ...
  customers: {
    ...
    error: {
      ...
      message:
        "Sorry, there was an issue with the customer operation. Please try again.",
    },
  },
  ...
  invoices: {
    ...
    downloaded: {
      ...
      message:
        "The invoice PDF has been successfully generated and downloaded.",
    },
    emailSent: {
      title: "Invoice Sent",
    ...
    error: {
      title: "Invoice Error",
      message:
        "Sorry, there was an issue with the invoice operation. Please try again.",
    },
  },
  ...
  payments: {
    ...
    linkGenerated: {
      ...
      message:
        "Payment link has been successfully created and is ready to share.",
    },
    error: {
      title: "Payment Error",
      message:
        "Sorry, there was an issue with the payment operation. Please try again.",
    },
  },
