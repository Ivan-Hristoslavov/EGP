        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6">
                    ...
                    {invoice.customer && (
                      <>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm font-medium text-gray-900 dark:text-white break-words max-w-xs text-right">
            ...
            {invoice.image_attachments &&
              invoice.image_attachments.length > 0 && (
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 max-h-96 overflow-y-auto">
                    {invoice.image_attachments.map(
                      (image: ImageAttachment, index: number) => (
                        <div
                          key={index}
                ...
                <div>
                  ...
                  {selectedImage.originalSize && (
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Size:{" "}
                      {(selectedImage.originalSize / 1024 / 1024).toFixed(1)}MB
                    </div>
                  )}
                </div>
                <a
