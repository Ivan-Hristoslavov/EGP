        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1 transition-colors duration-300">
              Learn how to use your admin panel effectively with these
            ...
            <nav className="p-4 space-y-2 max-h-96 overflow-y-auto">
              {filteredItems.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  >
                    <path
                      d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29-1.009-5.824-2.562M15 6.334A7.97 7.97 0 0012 5c-2.34 0-4.29 1.009-5.824 2.562"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth={2}
                    />
          ...
          {activeItemData ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Choose a guide topic from the sidebar to get started with
                helpful information.
              </p>
            </div>
          )}
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-purple-800 dark:text-purple-200 mb-4">
              If you can't find what you're looking for in these guides, here
