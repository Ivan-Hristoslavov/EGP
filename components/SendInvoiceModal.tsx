          ...
          <div className="mb-6">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Customer will receive a secure payment link for{" "}
            ...
            {includePaymentLink && (
              <div className="mt-4 ml-7">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Note: Amount will be converted from £
                  {invoice.total_amount.toFixed(2)} to{" "}
                  {selectedCurrencyData.symbol} at current exchange rates.
                </p>
              </div>
            )}
          </div>
            ...
            <div className="flex">
              ...
              <div>
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  This action will send the invoice email to the customer and
                  mark it as "Sent".
                </p>
              </div>
            </div>
