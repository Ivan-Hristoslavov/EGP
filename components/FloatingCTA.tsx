    ...
    <div className="fixed bottom-6 right-4 sm:right-0 z-50">
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="relative group">
          {/* Glow effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-red-500 to-orange-500 rounded-full blur opacity-40 group-hover:opacity-60 transition-opacity duration-300 animate-pulse" />

          {/* Button */}
          <a
            aria-label={
              businessPhone
                ? `Call ${businessPhone} for 10 minute free consultation`
                : "Call us"
            }
