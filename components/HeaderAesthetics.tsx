...
export default function HeaderAesthetics() {
  ...
  const showContactRow =
    profileLoading || contactEmail.length > 0 || contactPhone.length > 0;

  const showMobileAfterFindUsSep = showContactRow || hasSocialBar;
  const showMobileBetweenContactsAndSocial = showContactRow && hasSocialBar;
  ...
  const getConditionPrice = (
    ...
    const prices = treatments
      .map((t: string | unknown) =>
        typeof t === "string" ? t.match(/£(\d+(?:\.\d+)?)/) : null,
      )
    ...
    <>
      <header
        ...
        className={`fixed top-0 left-0 right-0 transition-all duration-300 ${
          scrolled
            ? "bg-[#E6DDD1] dark:bg-gray-900 shadow-lg"
            : "bg-[#E6DDD1]/95 dark:bg-gray-900/95 backdrop-blur-sm"
        }`}
        style={{ zIndex: 9998 }}
      >
        <div className="bg-[#D4C9BC] dark:bg-gray-800 text-gray-900 dark:text-gray-100">
          <div className="container mx-auto px-2 sm:px-4">
            ...
            <div className="lg:hidden flex items-center justify-center gap-1.5 sm:gap-2 py-2 sm:py-2.5 text-[10px] sm:text-xs md:text-sm">
              ...
              <div className="flex items-center flex-shrink-0">
                ...
                >
                  ...
                  <span className="relative inline-block">
                    ...
                    <span className="absolute left-0 -bottom-1 h-0.5 w-0 bg-gradient-to-r from-[#CFC4B6] via-[#E6DDD1] to-[#F4EFE8] transition-all duration-300 ease-out group-hover:w-full" />
                  </span>
                </Link>
              </div>

              {showMobileAfterFindUsSep ? (
                <span
                  aria-hidden="true"
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                  {profileLoading ? (
                    <div className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-1 min-h-[40px] touch-manipulation">
                      ...
                      <div className="hidden sm:block h-3 w-20 sm:w-24 bg-gray-300 dark:bg-gray-600 rounded animate-pulse" />
                    </div>
                  ) : (
                    <a
                  ...
                  {profileLoading ? (
                    <div className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-1 min-h-[40px] touch-manipulation">
                      ...
                      <div className="hidden sm:block h-3 w-16 sm:w-20 bg-gray-300 dark:bg-gray-600 rounded animate-pulse" />
                    </div>
                  ) : (
                    <a
              ...
              {showMobileBetweenContactsAndSocial ? (
                <span
                  aria-hidden="true"
                  className="text-gray-700/70 dark:text-gray-200/60 text-xs flex-shrink-0 px-1"
                >
        ...
        <div className="border-b border-[#D4C9BC] dark:border-gray-800">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="absolute inset-x-0 -bottom-1 h-0.5 bg-gradient-to-r from-[#CFC4B6] via-[#E6DDD1] to-[#F4EFE8] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-10" />
                  <span
                ...
                >
                  ...
                  />
                  <span className="absolute inset-x-0 -bottom-1 h-0.5 bg-egp-green transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-10" />
              ...
              <div className="col-start-3 row-start-1 flex min-w-0 items-center justify-end justify-self-end gap-2">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <span
                      className={`absolute inset-0 bg-gradient-to-r from-[#CFC4B6]/15 via-[#E6DDD1]/15 to-[#F4EFE8]/15 rounded-md transition-all duration-300 ${
                        activeMenu === "conditions"
                          ? "opacity-100"
                          : "opacity-0 group-hover:opacity-100"
                      }`}
                                    ...
                                    <li key={item.name}>
                                      ...
                                      >
                                        ...
                                        <span className="relative z-0 flex-1 min-w-0 truncate group-hover:translate-x-1 text-gray-800 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition-all duration-300">
                                          {item.name}
                                          <span className="absolute left-0 -bottom-0.5 w-0 h-px bg-egp-green dark:bg-egp-beige group-hover:w-full transition-all duration-300 ease-out origin-left" />
                                        </span>
                                        <span
                                          className={`relative z-0 flex-shrink-0 text-right min-w-0 ${hasDiscount ? "w-full flex justify-end" : ""}`}
                                        >
                                          <PriceWithDiscount
                                            align={
                                              hasDiscount ? "end" : "start"
                                            }
                                            compact={true}
                                            discountPercentage={
                      ...
                      <>
                                        ...
                                        >
                                          ...
                                          {priceInfo && (
                                            <span className="relative z-10 text-[11px] sm:text-xs font-semibold text-egp-green dark:text-egp-beige flex-shrink-0">
                                              £
                                              {Number.isInteger(priceInfo.price)
                                                ? priceInfo.price
                        ...
                        <div className="min-w-0 lg:col-span-2 flex flex-col justify-center pl-4 lg:pl-8 relative">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 max-w-xs">
                            Find the right treatment for your concern. Book a
                            consultation or browse our full conditions list.
                          </p>
                          <Link
      ...
      {isMounted &&
        ...
        createPortal(
          ...
          >
            ...
            {/* Slide-in Menu */}
            <div className="lg:hidden fixed inset-y-0 right-0 w-[90%] max-w-[420px] bg-[#E6DDD1] dark:bg-gray-900 shadow-2xl overflow-y-auto touch-manipulation animate-slideInRight pointer-events-auto">
              {/* Mobile Menu Header with Close Button */}
              <div className="sticky top-0 z-10 bg-[#E6DDD1] dark:bg-gray-900 border-b border-[#D4C9BC] dark:border-gray-700 px-4 py-4 flex items-center justify-between">
              ...
              <nav className="px-4 sm:px-6 py-4">
                <ul className="space-y-2">
                  ...
                  <li>
                    <button
                      className="w-full flex items-center justify-between px-4 py-3.5 min-h-[44px] text-base text-gray-700 dark:text-gray-300 hover:bg-[#D4C9BC] dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white rounded-lg font-light transition-all duration-200 active:scale-95 touch-manipulation font-montserrat uppercase tracking-widest"
                      onClick={() =>
                        setActiveMenu(
                    ...
                    {activeMenu === "treatments" && (
                      <div className="mt-3 pl-2 space-y-4 bg-[#EFEAE3] dark:bg-gray-800/50 rounded-lg p-4 border border-[#D4C9BC] dark:border-gray-700">
                                    ...
                                    <li key={item.name}>
                                      ...
                                      >
                                        ...
                                        <span className="relative flex-1 min-w-0 text-left leading-tight truncate pr-0">
                                          ...
                                          <span className="absolute left-0 right-0 -bottom-0.5 h-0.5 origin-left scale-x-0 bg-gradient-to-r from-[#CFC4B6] via-[#E6DDD1] to-[#F4EFE8] transition-transform duration-300 ease-out group-hover:scale-x-100" />
                                        </span>
                                        <span
                                          className={`flex-shrink-0 text-right min-w-0 z-0 ${hasDiscount ? "w-full flex justify-end" : ""}`}
                                        >
                                          <PriceWithDiscount
                                            align={
                                              hasDiscount ? "end" : "start"
                              ...
                              return (
                                <li key={condition.id}>
                                  ...
                                  >
                                    ...
                                    <span className="absolute left-2 right-2 -bottom-0.5 h-0.5 origin-left scale-x-0 bg-gradient-to-r from-[#CFC4B6] via-[#E6DDD1] to-[#F4EFE8] transition-transform duration-300 ease-out group-hover:scale-x-100" />
                                  </Link>
                                </li>
                              );
                            })}
                ...
                <div className="mt-6 flex justify-center border-t border-[#D4C9BC] dark:border-gray-700 pt-4">
                  <ThemeToggleButton />
                </div>
              </nav>
            </div>
