          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className={`${typography.headingHero} mb-6 text-white`}>
                Premium Aesthetics in{" "}
                <span className="text-yellow-300">{areaName}</span>
              </h1>
            ...
            {[
              {
                ...
                description:
                  "Advanced digital skin analysis to assess your skin condition and create a personalised treatment plan.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Professional aesthetic treatments with expert practitioners serving {areaName}.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Comprehensive facial aesthetic treatments including anti-wrinkle injections, fillers, and skin rejuvenation.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Professional body contouring and fat reduction treatments for {areaName} clients.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Professional medical-grade skin peels for skin renewal and improvement.",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Advanced regenerative treatments using PRP and exosome therapy for skin rejuvenation.",
              },
            ].map((service, index) => (
              <div
                key={index}
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Gas Safe registered with 10+ years experience and professional qualifications.",
                },
                {
                  title: "Fair Pricing",
                  description:
                    "Transparent pricing with no hidden costs - you pay exactly what we quote.",
                },
              ].map((benefit, index) => (
