...
export function ReviewForm() {
  ...
  const messageTooShort =
    formData.message !== "" && formData.message.trim().length < 20;
  const messageTooLong = formData.message.trim().length > 1000;
  const messageInvalid =
    formData.message !== "" && (messageTooShort || messageTooLong);
  ...
  if (submitResult) {
    return (
      <section
        className="py-8 sm:py-10 bg-egp-beige-lighter dark:bg-gray-900"
        id="leave-review"
      >
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`relative overflow-hidden rounded-xl sm:rounded-2xl p-5 sm:p-6 text-center ${
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                <svg
                  className={`w-10 h-10 ${submitResult.success ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <h3
                className={`text-2xl font-bold mb-3 ${submitResult.success ? "text-green-900 dark:text-green-100" : "text-red-900 dark:text-red-100"}`}
              >
    ...
    >
      <div className={layout.containerNarrow}>
        ...
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h2 className={`${typography.headingSection} ${textColors.heading} mb-1.5 sm:mb-2`}>
        ...
        <div className="bg-white/95 dark:bg-gray-900/70 rounded-2xl shadow-xl border border-[#e4d9c8] dark:border-gray-700 backdrop-blur overflow-hidden">
          <div className="px-4 sm:px-6 py-3 bg-gradient-to-r from-[#CFC4B6] via-[#E6DDD1] to-[#F4EFE8] text-[#3f3a31]">
            <p className="text-xs sm:text-sm font-semibold text-center tracking-wide uppercase text-white">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <Input
                ...
                classNames={{
                  base: "w-full",
                  label:
                    "text-sm font-semibold text-[#6b5f4b] dark:text-gray-200",
                  inputWrapper:
            ...
            <div className="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400">
              ...
              <span
                className={`font-medium ${messageTooLong ? "text-red-500 dark:text-red-400" : ""}`}
              >
