...
export function AdminDayOffManager() {
  ...
  const { periods, loading, error, addPeriod, updatePeriod, deletePeriod } =
    useDayOffPeriods();
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold">
                      {editingId
                        ? "Edit Day Off Period"
                        : "Add New Day Off Period"}
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 text-xs">
                      {editingId
                        ? "Update your day off period settings"
                        : "Create a new day off period for your business"}
                    </p>
                  </div>
                </div>
                <button
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-blue-700 dark:text-blue-300">
                        <p className="font-medium mb-1">
                          Today's date automatically disabled
                        </p>
                        <p>
                          When you create a day-off period starting today,
                          today's date will be immediately disabled in the
                          booking calendar to prevent new bookings.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl transform transition-all animate-fade-in-up">
            <div className="p-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Are you sure you want to delete this day off period? This action
                cannot be undone.
              </p>
