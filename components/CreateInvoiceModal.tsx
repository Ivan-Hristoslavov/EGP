...
export function CreateInvoiceModal({
  ...
  const filteredBookings =
    formData.customer_id && customers && bookings
      ? bookings.filter((b) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-[95vw] sm:max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        >
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-blue-800 dark:text-blue-200">
              ...
              {vatSettings?.is_enabled && (
                <div>
                  <strong>VAT:</strong>{" "}
                  {vatSettings.vat_number || "GB123456789"}
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
              These images will be sent with the invoice email (Max 5 images,
              10MB each)
            </p>
