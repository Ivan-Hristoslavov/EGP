        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 flex-1">
            <div className="flex items-center space-x-3">
              <div
                className={`bg-amber-700 rounded-full flex items-center justify-center animate-pulse shadow-lg transition-all duration-300 ${
              ...
              <span
                className={`font-bold text-amber-900 uppercase tracking-wide transition-all duration-300 ${
            ...
            <div className="flex-1">
              <span
                className={`text-amber-900 font-medium transition-all duration-300 ${
                  isScrolled ? "text-xs" : "text-sm"
                }`}
              >
            ...
            <div
              className={`${isPreview ? "flex" : "hidden md:flex"} items-center`}
            >
              <div
                className={`bg-amber-600/30 rounded-full px-4 flex items-center space-x-2 shadow-inner transition-all duration-300 ${
                  isScrolled ? "py-1" : "py-2"
                }`}
              >
                <span
                  className={`text-amber-900 transition-all duration-300 ${
                ...
                <span
                  className={`font-semibold text-amber-900 transition-all duration-300 ${
                    isScrolled ? "text-xs" : "text-sm"
                  }`}
                >
